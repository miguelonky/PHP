...
$rp=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where genero = '{$_GET['genero']}' ");
	      $var=1;
  ...
  <div class="main">
  	...
  	<div class="content_top">
    		...
    		<p><a href="index.php">Inicio</a> &gt;&gt; 
    		 <a href="#" class='active'>Busqueda</a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
      <div class="content">
    	<div class="content_top">
    		<div class="heading">
    <h3>Resultado de busqueda  para : <?php 
     if(isset($_GET['Busqueda'])) {
    	    echo $_GET['Busqueda'];    
    } 
     else{
     	$msj = "No ahy resultados para esta busqueda ";
    echo $msj;
     }
    ?> </h3>
    		</div>
	      ...
	      //ORDER BY id_auto_increment DESC LIMIT 3
           if (isset($_GET['Busqueda'])){
	      $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where nombre like '%{$_GET['Busqueda']}%' ");
	      $var=1;
	       if(mysqli_fetch_array($ra)==null) {
             echo "<div class='content_top'>
    		<div class='heading'>
    <h3>No existe ninguna pelicula con este nombre </h3>";
	       }
	       $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where nombre like '%{$_GET['Busqueda']}%' ");
