...
$rp=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where idioma = '{$_GET['idioma']}' ");
	      $var=1;
...
<body>
  ...
  <div class="main">
  	...
  	<div class="content_top">
    		...
    		<a href="index.php" >Idioma</a>&gt;&gt;
    		 <a href="#" class='active'><?php if (isset($_GET['idioma']))echo $_GET['idioma']; ?></a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
      <div class="content">
    	<div class="content_top">
    		<div class="heading">
    <?php	if (isset($_GET['idioma']))	echo "<h3>Idioma : {$_GET['idioma']}</h3>";?>
    		</div>
    	</div>
	      ...
	      //ORDER BY id_auto_increment DESC LIMIT 3
           if (isset($_GET['idioma'])){
	      $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where idioma = '{$_GET['idioma']}' ");
	      $var=1;
