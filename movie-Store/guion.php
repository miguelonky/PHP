...
include("lib/motor.php");
 if(isset($_GET['guion'])){
$rp=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where guion = '{$_GET['guion']}' ");
	      $var=1;
...
<body>
  ...
  <div class="main">
  	...
  	<div class="content_top">
    		...
    		<a href="index.php" >Guion</a>&gt;&gt;
    		 <a href="todas.php" class='active'><?php if (isset($_GET['guion']))echo $_GET['guion']; ?></a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
      <div class="content">
    	<div class="content_top">
    		<div class="heading">
    <?php	if (isset($_GET['guion']))	echo "<h3>Guion : {$_GET['guion']}</h3>";?>
    		</div>
    	</div>
	      ...
	      //ORDER BY id_auto_increment DESC LIMIT 3
           if (isset($_GET['guion'])){
	      $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where guion = '{$_GET['guion']}' ");
	      $var=1;
