...
include("lib/motor.php");
 if(isset($_GET['fecha'])){
$rp=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where ano = {$_GET['fecha']} ");
	      $var=1;
...
<body>
  ...
  <div class="main">
  	...
  	<div class="content_top">
    		...
    		<a href="#" >Año</a>&gt;&gt;
    		 <a href="#" class='active'><?php if (isset($_GET['fecha']))echo $_GET['fecha']; ?></a></p>
    	    </div>
    	    add
    		<div class="clear"></div>
    	</div>
      <div class="content">
    	<div class="content_top">
    		<div class="heading">
    <?php	if (isset($_GET['fecha']))	echo "<h3>Año : {$_GET['fecha']}</h3>";?>
    		</div>
    	</div>
	      ...
	      //ORDER BY id_auto_increment DESC LIMIT 3
           if (isset($_GET['fecha'])){
	      $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where ano = '{$_GET['fecha']}' ");
	      $var=1;
