...
include("lib/motor.php");
 if(isset($_GET['pais'])){
$rp=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where pais = '{$_GET['pais']}' ");
	      $var=1;
...
<body>
  ...
  <div class="main">
  	...
  	<div class="content_top">
    		...
    		<a href="#" >Pais</a>&gt;&gt;
    		 <a href="#" class='active'><?php if (isset($_GET['pais']))echo $_GET['pais']; ?></a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
      <div class="content">
    	<div class="content_top">
    		<div class="heading">
    <?php	if (isset($_GET['pais']))	echo "<h3>Pais : {$_GET['pais']}</h3>";?>
    		</div>
    	</div>
	      ...
	      //ORDER BY id_auto_increment DESC LIMIT 3
           if (isset($_GET['pais'])){
	      $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where pais = '{$_GET['pais']}' ");
	      $var=1;
