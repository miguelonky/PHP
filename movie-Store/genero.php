  ...
  <div class="main">
  	...
  	<div class="content_top">
    		...
    		<a href="index.php" >Categoria</a>&gt;&gt;
    		 <a href="todas.php" class='active'><?php if (isset($_GET['genero']))echo $_GET['genero']; ?></a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
      <div class="content">
    	<div class="content_top">
    		<div class="heading">
    <?php	if (isset($_GET['genero']))	echo "<h3>Genero : {$_GET['genero']}</h3>";?>
    		</div>
    	</div>
	      ...
	      //ORDER BY id_auto_increment DESC LIMIT 3
           if (isset($_GET['genero'])){
	      $ra=mysqli_query(conexion::obtenerInstancia(),"select * from peliculas where genero = '{$_GET['genero']}' ");
	      $var=1;
